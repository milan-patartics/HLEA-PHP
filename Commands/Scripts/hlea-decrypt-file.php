...
/**
 * Decrypts the input file and saves the decrypted results to the output file.
 *
 * @param array $args
 *
 ...
 * @throws \HLEA\Exceptions\InvalidBinaryData
 */
function hleaDecryptFile(array $args): void
{
    echo PHP_EOL .
         '===========================================================================' . PHP_EOL .
         'Welcome to the HLEA (High Level Encryption Algorithm) file decryption tool!' . PHP_EOL .
         '===========================================================================' . PHP_EOL .
         PHP_EOL;
    ...
    if(isset($args['input'])){
        ...
        echo PHP_EOL . 'Error (Missing Argument)!' . PHP_EOL .
             ...
             'php hlea-decrypt-file input="/home/user/file.dat.hleafile" key="/home/user/key.hleakey" output="/home/user/file.decrypted.dat"' . PHP_EOL . PHP_EOL .
             'MacOS example:' . PHP_EOL .
             'php hlea-decrypt-file input="/Users/user/Documents/file.dat.hleafile" key="/Users/user/Documents/key.hleakey" output="/Users/user/Documents/file.decrypted.dat"' . PHP_EOL . PHP_EOL .
             'Windows example:' . PHP_EOL .
             'php hlea-decrypt-file input="C:\Users\user\Documents\file.dat.hleafile" key="C:\Users\user\Documents\key.hleakey" output="C:\Users\user\Documents\file.decrypted.dat"' . PHP_EOL . PHP_EOL .
             'Terminating...' . PHP_EOL;
    ...
    echo PHP_EOL . 'Starting HLEA file decryption with the following parameters:' . PHP_EOL .
         '===========================================================================' . PHP_EOL .
    ...
    sleep(1);
    echo 'Decrypting input file data...' . PHP_EOL .
         'This may take some time depending on the input file\'s size.' . PHP_EOL . PHP_EOL;
    $processor = new Processor($key);
    $processor->decryptFile($args['input'], $args['output']);
    echo 'HLEA file decryption finished successfully.' . PHP_EOL . PHP_EOL .
         'The decrypted file has been saved to:' . PHP_EOL .
